...
<div class="container mb-5 ">
    ...
    <div class="row mt-5">
        ...
        <div class="col-6 " >
            <button style="float:right ; background-color: #0a4275; color: white;" class="btn  p-1">Ähli habarlar</button>
        </div>
...
<div class="container mb-5 ">
    ...
    <div class="row mt-5">
        ...
        <div class="col-6 " >
            <button style="float:right ; background-color: #0a4275; color: white;" class="btn  p-1">Ähli makalalar</button>
        </div>
        <div style="width: 100%; height:1px; background-color:rgb(90, 90, 90)"></div>
